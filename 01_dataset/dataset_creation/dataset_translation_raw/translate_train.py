...
def translate_dataset_to_language(language):
    ...
    original_dataset_path = "/home/obehre/gsm-eval/dataset_translation/train/train-en.jsonl"
    new_dataset_path = f"/home/obehre/gsm-eval/dataset_translation/train_translated/train-{language}.jsonl"
    ...
    with open(original_dataset_path, 'r') as file:
        ...
        for line in file:
            ...
            while success == False:
                try:
                    print(f"Processing entry {entry_count} / 7473 | {entry_count / 7473 * 100:.2f}%", end="\r")
                    ...
                    if(retry_count > 10):
                        print(f"ERROR: After trying to process entry {entry_count} / 7473 this script will be shut down.")
                        exit()

                    print(f"WARNING: Exception processing entry {entry_count} / 7473")
                    warning_count += 1
                    time.sleep(20)
                    print("Retrying...")
